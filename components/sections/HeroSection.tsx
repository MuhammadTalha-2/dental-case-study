...
import CalendlyInline from "../ui/CalendlyInline";
        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          <div className="lg:col-span-7">
            ...
            <h1 className="animate-fade-up [animation-delay:100ms] text-4xl md:text-6xl font-bold text-slate-900 leading-tight mb-6">
              ...
              <span className="text-gradient-brand">62 New Patients</span>{" "}
              Monthly
            </h1>
          ...
          <div className="lg:col-span-5 animate-fade-up [animation-delay:400ms]">
            <CalendlyInline url="https://calendly.com/inshalytics-sales/30min" />
          </div>
        </div>
      </div>
    </section>
